---
title: "TryHackMe - Attacktive Directory 解説 (Windows)"
date: 2026-02-27
...
| OS | Windows |
| 難易度 | 記録なし |
| 攻撃対象 | 53/tcp   open  domain, 80/tcp   open  http, 88/tcp   open  kerberos-sec, 135/tcp  open  msrpc, 139/tcp  open  netbios-ssn, 389/tcp  open  ldap |
| 主な侵入経路 | web, smb attack path to foothold |
