---
title: "Proving Grounds - LaVita 解説 (Linux)"
date: 2026-02-25
...
| OS | Linux |
| 難易度 | 記録なし |
| 攻撃対象 | `22/tcp` (SSH), `80/tcp` (Apache/Laravel web app) |
| 主な侵入経路 | Laravel Ignition RCE (`CVE-2021-3129`) |
| 権限昇格経路 | Writable cron-executed `artisan` -> `skunk` -> `sudo NOPASSWD composer` -> root |
