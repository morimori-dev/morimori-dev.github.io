...
date: 2026-02-27
permalink: /en/posts/htb-jarvis/
legacy_permalink: /posts/htb-jarvis/
...
| Attack Surface            | 22/tcp (ssh), 80/tcp (http), 64999/tcp (http) |
| Primary Entry Vector      | SQL injection in exposed web functionality |
| Privilege Escalation Path | SUID enumeration -> GTFOBins-compatible binary abuse -> root/administrator |
