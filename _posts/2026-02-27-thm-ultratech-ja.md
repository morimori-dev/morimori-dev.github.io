...
date: 2026-02-27
permalink: /ja/posts/thm-ultratech/
legacy_permalink: /posts/thm-ultratech-ja/
description: "TryHackMe UltraTech Windows マシン解説。実践的な悪用手順と権限昇格テクニックを解説。"
...
| OS | Windows |
| 難易度 | 記録なし |
| 攻撃対象 | 21/tcp   open     ftp, 22/tcp   open     ssh, 8081/tcp open     http, 8093/tcp filtered unknown, 21/tcp    open  ftp, 22/tcp    open  ssh |
| 主な侵入経路 | sqli |
