---
title: "HackTheBox - Editor 解説 (Linux)"
date: 2026-02-27
description: "HackTheBox Editor Linux writeup マシン解説。サービス列挙・初期足がかり・権限昇格経路を解説。"
...
| OS | Linux |
| 難易度 | 記録なし |
| 攻撃対象 | 22/tcp (ssh), 80/tcp (http), 8080/tcp (http) |
| 主な侵入経路 | Public exploit path involving CVE-2024-32019 |
