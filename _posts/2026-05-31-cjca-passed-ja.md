...
| フェーズ | 内容 | 配点 |
|---|---|---|
| **Red Team** | マシンへの侵入テスト（User + Root フラグ） | **100 点満点** |
...
- **Blue Team 経験**: 業務で Splunk を日常的に触っていたため、SIEM の基本操作や alert の読み方にはやや慣れていた。TP/FP の判断基準を体系的に学ぶのは今回が初めて

### なぜ CJCA を受けようと思ったか

**CPTS のバウチャーを購入したら CJCA のバウチャーが付いてきた**からです。せっかくなので使おうと受験しました。

結果的には非常に内容の濃い試験で、特に Blue Team フェーズと商用品質レポートの要件は、OSCP にはない学びを与えてくれました。「ついでに受けた試験」が予想外に刺さった、というのが正直なところです。攻撃と防御の両面を体系的に学びたいジュニアや初学者には特におすすめできる試験です。

---

## Day 1〜2: Red Team — 10/10 フラグ
...
| 時期 | 進捗 |
|---|---|
| Day 1 午前 | 試験開始、全マシン同時 nmap 投入・偵察 |
| Day 1 中 | **1台目・2台目 侵害完了** |
| Day 1 終盤 | **3台目 侵害完了** |
| Day 2 午前 | **4台目 侵害完了** |
| Day 2 昼 | **5台目 侵害完了**、Red Team 完全制覇確認 |
| Day 2 以降 | Blue Team・レポート作成に移行 |

### Red Team を通じた気づき

OSCP の学習・受験で身につけた技術がそのまま通用する内容でした。改めて特殊な準備は不要で、OSCP の延長線上で臨めます。列挙（enumeration）の深さが直接的に得点に結びつく試験なので、幅広く列挙してから優先度をつける OSCP での習慣がそのまま活きました。

---

## Day 3〜4: Blue Team — 攻撃の足跡を SIEM で追跡

Red Team 終了後、Day 3 から Blue Team に移りました。SIEM 環境のアラートを TP/FP 分類していきます。業務で Splunk を使っていたおかげで、ツールの違いはあれど alert の読み方や調査の進め方は大きく変わらず、スムーズに取り組めました。
...
Red Team が Day 2 中に終わったため、残り 3 日間をレポートと triage に充てられました。これが品質面で大きく効いたと感じています。
...
- **Red Team を最優先して早めに終わらせたこと**: 残りの日数をレポートと Blue Team に集中できた。「100 点でもレポート不良で不合格」という試験の性質上、Red Team が終わったら即レポートに移る判断が正解でした
