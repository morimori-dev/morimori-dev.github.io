...
- **Red Team**: 5 マシン / 10 フラグすべてを **Day 2 中に完全制覇**
...
| 結果 | **PASSED（100 / 100）** |
| Red Team | 5 マシン 10 flag 全制覇（Day 2 完了） |
| Blue Team | triage 完了 |
...
- **Blue Team 経験**: 業務で Splunk を日常的に触っていたため、SIEM の基本操作や alert の読み方には慣れていた。TP/FP の判断基準を体系的に学ぶのは今回が初めて
