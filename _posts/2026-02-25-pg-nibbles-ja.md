---
title: "Proving Grounds - Nibbles 解説 (Linux)"
date: 2026-02-25
...
| 主な侵入経路 | Default PostgreSQL credentials (`postgres:postgres`) on exposed DB service |
| 権限昇格経路 | SUID `find` (`/usr/bin/find`) abused with GTFOBins |
