...
date: 2026-03-11
permalink: /en/posts/pg-ochima/
legacy_permalink: /posts/pg-ochima/
...
The key finding is `Maltrail/0.52` on port `8338`, which matches CVE-2023-27163 and points directly to an unauthenticated RCE path.
