...
- **ホワイトボード** — AD の構成図やピボット経路をその場で描いて整理するのに使った。頭の中だけで持ちきれない AD の接続関係が一目で見えるようになり、詰まったときの打開策を考えるのが格段に楽になった
  ...
  ![試験当日のホワイトボード](/assets/img/life/oscp/whiteboard.jpeg)
...
- **CopyQ でスクリーンショット管理を統一したこと**: クリップボードマネージャーの [CopyQ](https://hluk.github.io/CopyQ/) を使い、スクショ撮影にショートカットを割り当てた。撮影時にそのまま枠やハイライトを追加できるのが特に便利で、証跡整理の手が止まらなくなった。試験中のスクショ抜けは不合格直結なので、撮る→貼るの動作を完全に体に染み込ませておいて本当によかった
