...
| Primary Entry Vector      | Local file inclusion and configuration disclosure |
| Privilege Escalation Path | Writable scheduled task/script abuse -> privileged execution |
