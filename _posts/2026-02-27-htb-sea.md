...
date: 2026-02-27
permalink: /en/posts/htb-sea/
legacy_permalink: /posts/htb-sea/
description: "Hack The Box Sea Linux writeup with service enumeration, foothold strategy, and privilege escalation path."
categories: [HackTheBox, Linux]
tags: [hackthebox, linux, whatweb, dictionary-attack, xss, apache, ssh, hash-cracking, suid, searchsploit, web, privilege-escalation, pentest]
mermaid: true
content_lang: en
alt_ja: /ja/posts/htb-sea/
---
...
| Attack Surface            | 22/tcp (ssh), 80/tcp (http), 1080/tcp (tcpwrapped), 8000/tcp (http), 8888/tcp (http), 9000/tcp (nagios-nsca), 35023/tcp (http) |
