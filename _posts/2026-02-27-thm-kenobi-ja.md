...
date: 2026-02-27
permalink: /ja/posts/thm-kenobi/
legacy_permalink: /posts/thm-kenobi-ja/
...
| OS | Windows |
| 難易度 | 記録なし |
| 攻撃対象 | 21/tcp    open  ftp, 22/tcp    open  ssh, 80/tcp    open  http, 111/tcp   open  rpcbind, 111/tcp   rpcbind
|, 2049/tcp   nfs
| |
| 主な侵入経路 | smb-enumeration, upload-abuse |
