...
date: 2026-02-27
permalink: /en/posts/htb-tabby/
legacy_permalink: /posts/htb-tabby/
description: "Hack The Box Tabby Linux writeup with service enumeration, foothold strategy, and privilege escalation path."
...
| Attack Surface            | 22/tcp (ssh), 80/tcp (tcpwrapped), 8080/tcp (http) |
