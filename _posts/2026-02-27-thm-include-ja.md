---
title: "TryHackMe - Include 解説 (Linux)"
date: 2026-02-27
...
| OS | Linux |
| 難易度 | 記録なし |
| 攻撃対象 | 22/tcp    open  ssh, 25/tcp    open  smtp, 110/tcp   open  pop3, 143/tcp   open  imap, 993/tcp   open  ssl/imap, 995/tcp   open  ssl/pop3 |
| 主な侵入経路 | parameter-tampering, idor, lfi |
| 権限昇格経路 | Completed up to user flag |
